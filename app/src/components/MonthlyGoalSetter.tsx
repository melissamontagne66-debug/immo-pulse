      ...
      <div className="w-full max-w-lg">
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
          <div className="bg-gradient-to-r from-red-500 to-red-600 px-6 py-4 flex items-center justify-between">
            <div>
              <h2 className="text-lg font-bold text-white">Objectifs de {monthLabel}</h2>
              <p className="text-red-100 text-sm">Ajuste ton cap — les objectifs sont toujours par jour</p>
            </div>
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="bg-red-50 rounded-xl p-4 border border-red-200">
              <p className="text-xs text-red-600 font-medium uppercase tracking-wide mb-3">Tes objectifs AUJOURD'HUI</p>
              <div className="grid grid-cols-2 gap-3">
                <div className="flex items-center gap-3 p-3 bg-white rounded-lg">
                  <Phone className="w-5 h-5 text-blue-600" />
                  <div>
                    <p className="text-xl font-bold text-gray-900">{Math.max(10, Math.ceil(targets.appelsTarget / 22))}</p>
                    <p className="text-xs text-gray-500">conversations/jour</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 p-3 bg-white rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">contacts physiques/jour</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 p-3 bg-white rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">R1/jour</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 p-3 bg-white rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">R2/jour</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-amber-50 rounded-xl p-4 border border-amber-200">
              <p className="text-sm text-amber-800">
                <strong>Conseil des meilleurs</strong><br />
            ...
            <div className="flex gap-3">
              ...
              <Button onClick={handleSave} className="flex-1 bg-red-600 hover:bg-red-700">
                <Sparkles className="w-4 h-4 mr-2" /> Enregistrer
              </Button>
            </div>
          </div>
        </div>
