  ...
  const pillarsFr = [
    {
      ...
      ideas: [
        'Présente-toi : qui tu es, quel secteur tu couvres et pourquoi tu aimes ce métier.',
    ...
    .map(def => {
      switch (def.type) {
        ...
        case 'admin':
          ...
          if (def.id === 'blocs-agenda-jour-1') {
            return {
              ...
              description: isEs
                ? 'La regularidad es la clave de ventas regulares: bloquea en tu agenda, cada día, EN RECURRENCIA (todos los días laborables), 30 min al inicio de la jornada para enviar los mensajes sobre los anuncios + 1 h de terreno + 1 h de administrativo.\n\nPonerlos en recurrencia es lo que te protege: no tendrás que recrearlos cada semana.\n\nEstas franjas son sagradas: no pongas citas encima.\n\nSi una cita es inevitable, mueve inmediatamente la franja a otro momento del mismo día — nunca la elimines.'
                : 'La régularité est la clé de ventes régulières : bloque dans ton agenda, chaque jour, EN RÉCURRENCE (tous les jours ouvrés), 30 min en début de journée pour envoyer tes messages sur les annonces + 1 h de terrain + 1 h d\'administratif.\n\nLes mettre en récurrence, c\'est ce qui te protège : tu n\'auras pas à les recréer chaque semaine.\n\nCes blocs sont sacrés : tu ne poses pas de RDV dessus.\n\nEt si un RDV est inévitable, tu recales immédiatement le bloc concerné à un autre moment de la même journée — tu ne le supprimes jamais.',
            };
          }
          return {
            ...def,
          ...
          return {
            ...
            description: profile.expérienceLevel === 'confirmé'
              ? (isEs
                ...
                : 'En tant qu\'agent confirmé, ta primo liste c\'est tes ANCIENS CLIENTS — vendeurs et acheteurs. Appelle-les aujourd\'hui : "Bonjour, c\'est [Ton prénom], je repassais vers vous pour prendre de vos nouvelles. Votre installation se passe bien ?" Écoute, puis demande : "Au fait, j\'ai changé d\'agence / de réseau — qui connaissez-vous autour de vous qui envisage de vendre, de chercher un bien, ou qui souhaite simplement connaître la valeur de son patrimoine ?" Chaque ancien client satisfait = 2 à 3 recommandations naturelles.')
              : (isEs
        ...
        case 'gmb':
          return {
            ...def,
            title: isEs ? '🌐 Google Business Profile — Sé el referente de tu sector' : '🌐 Google Business Profile — Sois LE référent de ton secteur',
            description: isEs
              ? 'Antes de empezar, mira el vídeo de formación dedicado a Google Business Profile (pestaña Formaciones — cuenta de formación requerida).\n\n¡Pon en marcha tu ficha Google Business Profile hoy! Es TU vitrina digital : cuando alguien busca "agente inmobiliario [tu ciudad]", debes aparecer en primer lugar.\n\n**Acciones de hoy:**\n→ Crea o completa tu ficha Google Business Profile\n→ Añade fotos profesionales de ti y de tu sector\n→ Redacta una descripción clara con tus palabras clave\n→ Pide 3 reseñas a tus primeros contactos (familia, amigos, antiguos clientes)\n\n💡 **Por qué te va a reportar:** Una ficha de Google Business Profile bien cuidada te ahorra cientos de euros de publicidad. Una ficha completa y actualizada son llamadas de más — sin gastar un céntimo. Tu competencia duerme en este canal — aprovéchalo.'
              : 'Avant de commencer, regarde la vidéo de formation dédiée à Google Business Profile (onglet Formations — compte formation requis).\n\nMets en route ta fiche Google Business Profile aujourd\'hui ! C\'est TA vitrine digitale : quand quelqu\'un cherche "conseiller immobilier [ta ville]", tu dois apparaître en premier.\n\n**Actions du jour :**\n→ Crée ou complète ta fiche Google Business Profile\n→ Ajoute des photos professionnelles de toi et de ton secteur\n→ Rédige une description claire avec tes mots-clés\n→ Demande 3 avis à tes premiers contacts (famille, amis, anciens clients)\n\n💡 **Pourquoi ça va te rapporter :** Une fiche Google Business Profile bien tenue te fait économiser des centaines d\'euros de publicité. Une fiche complète et à jour, c\'est des appels en plus — sans dépenser un centime. Ta concurrence dort sur ce canal — profite-en.',
          };
        case 'gmb-hebdo':
          return {
            ...def,
