              ...
              <div className="space-y-4">
                ...
                {stats.callsMade > 0 && stats.contactsApproached === 0 && (
                  <div className="bg-white rounded-lg p-4 border border-amber-100">
                    ...
                    <p className="text-sm text-gray-700 leading-relaxed">Le téléphone est utile, mais un contact physique vaut 10 appels. Quand tu appelles, l'objectif n'est pas de vendre au téléphone — c'est de <strong>fixer un RDV terrain</strong>. Ton script : "Je vais être dans votre secteur demain vers 11h, est-ce que je peux passer vous apporter une info sur la valeur des biens de la rue ?" Si le proprio n'est pas dispo : "Pas de souci, je repasserai dans le secteur — est-ce que toi ou quelqu'un de la famille sera là jeudi ou vendredi matin ?" La règle des 2 options fonctionne à chaque fois. <strong>Objectif mois prochain : transformer 20% de tes conversations en contacts physiques.</strong></p>
                  </div>
                )}
                {stats.rdvR1Done > 0 && stats.rdvR2Done === 0 && (
                  <div className="bg-white rounded-lg p-4 border border-amber-100">
                    ...
                    <p className="text-sm text-gray-700 leading-relaxed">Le R1 c'est la découverte — mais le but, c'est de fixer le R2 <strong>AVANT de partir</strong>. Dès le début du R1, pose les bonnes questions : "Au-delà du prix, qu'est-ce qui est le plus important pour vous ?" Écoute 80%, parle 20%. Avant de partir : "Je vais préparer un rapport complet avec les comparables, les délais de vente du secteur et ma stratégie de mise en vente. Est-ce que mercredi 18h ou jeudi 14h vous convient mieux ?" — utilise <strong>la règle des 2 options</strong>, jamais "quand êtes-vous dispo ?". La certitude dans la voix vend le RDV. <strong>Objectif mois prochain : fixer un R2 pour chaque R1 réalisé.</strong></p>
                  </div>
                )}
                {stats.rdvR2Done > 0 && stats.mandatsSigned === 0 && (
                  <div className="bg-white rounded-lg p-4 border border-amber-100">
                    ...
                    <p className="text-sm text-gray-700 leading-relaxed">Le R2, c'est le moment de vérité. Ta mission : <strong>PRÉSENTER ET VALIDER TES SERVICES EN PREMIERS</strong>. Commence par la Clause de Confiance et la Garantie 30 jours — prouve la valeur de ton accompagnement AVANT de donner le prix. Sinon, le vendeur n'écoutera plus rien après le prix. Utilise les 3 scénarios (optimiste, réaliste, prudent). Après avoir donné le prix : <strong>silence complet</strong>. Le premier qui parle a perdu. Si le vendeur hésite : "Je comprends que c'est une décision importante. Prenez 24h pour en parler en famille, et je vous rappelle demain même heure. D'accord ?" <strong>Objectif mois prochain : signer 1 mandat pour 2 R2 réalisés.</strong></p>
                  </div>
                )}
                ...
                {stats.visitesDone > 0 && stats.offresWritten === 0 && (
                  <div className="bg-white rounded-lg p-4 border border-amber-100">
                    ...
                    <p className="text-sm text-gray-700 leading-relaxed">Les visites sans offre, c'est du temps perdu. Pendant la visite, <strong>crée l'urgence</strong> chez l'acheteur : "Ce bien correspond à ce que vous cherchiez — j'ai 3 autres acquéreurs intéressés sur ce type de bien ce mois-ci, dont un qui visite demain. Si vous êtes convaincu, je vous recommande de faire une offre rapidement." Dès la visite, envoie un SMS de relance : "Merci pour la visite, j'ai reçu un signal positif du vendeur. Êtes-vous prêt à faire une offre ?" Si l'acheteur hésite sur le prix : propose un compromis avec une contrepartie (délai de rétractation raccourci, mobilier inclus, etc.). <strong>Objectif mois prochain : 1 offre pour 2 visites minimum.</strong></p>
                  </div>
                )}
                {parseFloat(stats.avgMood) < 3 && stats.daysTracked > 3 && (
                  <div className="bg-white rounded-lg p-4 border border-amber-100">
                    ...
                    <p className="text-sm text-gray-700 leading-relaxed">L'immobilier est un métier émotionnellement exigeant. Une humeur basse sur plusieurs jours est un signal d'alerte. Voici ce que tu peux faire : <strong>1)</strong> Célèbre chaque micro-victoire — une porte toquée, un contact enregistré, un R1 fixé. <strong>2)</strong> Parle à ton manager ou un collègue confirmé, même 10 minutes par jour. <strong>3)</strong> Varie ton secteur — si une rue te résiste, change de zone. <strong>4)</strong> Fais du picking en duo avec un collègue, c'est plus motivant. <strong>5)</strong> Rappelle-toi : chaque "non" te rapproche du "oui". Les tops performers ont tous connu des semaines difficiles au début. Ce qui compte, c'est que tu reviennes demain.</p>
                  </div>
                )}
