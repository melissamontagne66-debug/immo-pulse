...
3. **Chaque relance = un RDV potentiel.** Un contact qui a déjà reçu une estimation de toi = 3x plus facile à convertir qu'un contact froid.`,
  ...
  // J44 — Apporteurs : gardienne
  {
    ...
    description: `La gardienne d'immeuble sait TOUT : qui divorce, qui attend un enfant, qui hérite, qui s'en va. C'est la pige immobilière à la source historique.

**Ton script** :
"Bonjour [Prénom], vous faites un super boulot pour tenir la résidence. Comme vous êtes au cœur de l'immeuble, vous savez toujours tout avant tout le monde ! Dès que vous entendez parler d'un projet de vente, vous m'envoyez l'info. Si je vends, vous touchez 6\u00A0% de ma commission. Sur un appartement à 200 000€, ça vous fait un très beau chèque pour une simple info."`,
    script: 'Conseil méthodo — La gardienne = source d\'infos en temps réel. Elle connaît tous les mouvements de l\'immeuble. Tes scripts complets sont dans tes mémos.',
    objectif: '🎯 2 gardiennes contactées, 1 partenariat conclu minimum',
    duree: '1h',
  },
